...
\label{md_poc_autotoc_md22}%
\Hypertarget{md_poc_autotoc_md22}%
 \hypertarget{md_poc_autotoc_md23}{}\doxysection{\texorpdfstring{1. Introduction}{1. Introduction}}\label{md_poc_autotoc_md23}
This document outlines the technical reasoning behind choosing {\bfseries{SFML (Simple and Fast Multimedia Library)}} for the R-\/\+Type project, specifically focusing on architectural fit and networking capabilities compared to major alternatives (SDL2, Raylib, Qt).\hypertarget{md_poc_autotoc_md24}{}\doxysection{\texorpdfstring{2. Comparison with Alternatives}{2. Comparison with Alternatives}}\label{md_poc_autotoc_md24}
\hypertarget{md_poc_autotoc_md25}{}\doxysubsection{\texorpdfstring{A. SFML vs. SDL2 (\+Simple Direct\+Media Layer)}{A. SFML vs. SDL2 (Simple DirectMedia Layer)}}\label{md_poc_autotoc_md25}
...
\end{DoxyItemize}\hypertarget{md_poc_autotoc_md26}{}\doxysubsection{\texorpdfstring{B. SFML vs. Raylib}{B. SFML vs. Raylib}}\label{md_poc_autotoc_md26}
...
\end{DoxyItemize}\hypertarget{md_poc_autotoc_md27}{}\doxysubsection{\texorpdfstring{C. SFML vs. Qt (\+Qt 6)}{C. SFML vs. Qt (Qt 6)}}\label{md_poc_autotoc_md27}
...
\end{DoxyItemize}\hypertarget{md_poc_autotoc_md28}{}\doxysection{\texorpdfstring{3. Why SFML is the Superior Choice for R-\/\+Type}{3. Why SFML is the Superior Choice for R-Type}}\label{md_poc_autotoc_md28}
\hypertarget{md_poc_autotoc_md29}{}\doxysubsection{\texorpdfstring{A. Unified Networking \& Graphics}{A. Unified Networking \& Graphics}}\label{md_poc_autotoc_md29}
...
\end{DoxyItemize}\hypertarget{md_poc_autotoc_md30}{}\doxysubsection{\texorpdfstring{B. Protocol \& Serialization ($<$tt$>$sf\+::\+Packet$<$/tt$>$)}{B. Protocol \& Serialization (<tt>sf::Packet</tt>)}}\label{md_poc_autotoc_md30}
...
\end{DoxyItemize}\hypertarget{md_poc_autotoc_md31}{}\doxysubsection{\texorpdfstring{C. Modern C++ Compatibility}{C. Modern C++ Compatibility}}\label{md_poc_autotoc_md31}
...
\end{DoxyItemize}\hypertarget{md_poc_autotoc_md32}{}\doxysubsection{\texorpdfstring{D. Development Velocity}{D. Development Velocity}}\label{md_poc_autotoc_md32}
...
\end{DoxyItemize}\hypertarget{md_poc_autotoc_md33}{}\doxysection{\texorpdfstring{4. Architectural Study\+: ECS vs. OOP}{4. Architectural Study: ECS vs. OOP}}\label{md_poc_autotoc_md33}
\hypertarget{md_poc_autotoc_md34}{}\doxysubsection{\texorpdfstring{A. Traditional OOP (\+Object-\/\+Oriented Programming)}{A. Traditional OOP (Object-Oriented Programming)}}\label{md_poc_autotoc_md34}
...
\end{DoxyItemize}\hypertarget{md_poc_autotoc_md35}{}\doxysubsection{\texorpdfstring{B. ECS (\+Entity Component System) -\/ Chosen for R-\/\+Type}{B. ECS (Entity Component System) - Chosen for R-Type}}\label{md_poc_autotoc_md35}
...
\end{DoxyItemize}\hypertarget{md_poc_autotoc_md36}{}\doxysection{\texorpdfstring{5. Algorithms \& Data Structures}{5. Algorithms \& Data Structures}}\label{md_poc_autotoc_md36}
\hypertarget{md_poc_autotoc_md37}{}\doxysubsection{\texorpdfstring{A. Algorithms}{A. Algorithms}}\label{md_poc_autotoc_md37}
...
\end{DoxyItemize}\hypertarget{md_poc_autotoc_md38}{}\doxysubsection{\texorpdfstring{B. Data Structures}{B. Data Structures}}\label{md_poc_autotoc_md38}
...
{\bfseries{}}\hypertarget{md_poc_autotoc_md39}{}\doxysection{\texorpdfstring{6. Network Protocol \& Reliability}{6. Network Protocol \& Reliability}}\label{md_poc_autotoc_md39}
{\bfseries{}}

{\bfseries{}}\hypertarget{md_poc_autotoc_md40}{}\doxysubsection{\texorpdfstring{A. Hybrid Protocol Strategy}{A. Hybrid Protocol Strategy}}\label{md_poc_autotoc_md40}
{\bfseries{
\begin{DoxyItemize}
...
{\bfseries{}}\hypertarget{md_poc_autotoc_md41}{}\doxysubsection{\texorpdfstring{B. Protocol Documentation (\+RFC Style)}{B. Protocol Documentation (RFC Style)}}\label{md_poc_autotoc_md41}
{\bfseries{ The protocol is documented in {\ttfamily \doxylink{rfcprotocol_8txt}{rfcprotocol.\+txt}}, defining packet structures in Big-\/\+Endian format.
\begin{DoxyItemize}
...
{\bfseries{}}\hypertarget{md_poc_autotoc_md42}{}\doxysection{\texorpdfstring{7. Security \& Data Integrity}{7. Security \& Data Integrity}}\label{md_poc_autotoc_md42}
{\bfseries{}}

{\bfseries{}}\hypertarget{md_poc_autotoc_md43}{}\doxysubsection{\texorpdfstring{A. Vulnerabilities}{A. Vulnerabilities}}\label{md_poc_autotoc_md43}
{\bfseries{
\begin{DoxyItemize}
...
{\bfseries{}}\hypertarget{md_poc_autotoc_md44}{}\doxysubsection{\texorpdfstring{B. Mitigation \& Monitoring}{B. Mitigation \& Monitoring}}\label{md_poc_autotoc_md44}
{\bfseries{
\begin{DoxyItemize}
...
{\bfseries{}}\hypertarget{md_poc_autotoc_md45}{}\doxysection{\texorpdfstring{8. Documentation Strategy}{8. Documentation Strategy}}\label{md_poc_autotoc_md45}
{\bfseries{
\begin{DoxyItemize}
...
\item {\bfseries{Protocol Documentation\+:}} The network protocol is strictly defined in {\ttfamily \doxylink{rfcprotocol_8txt}{rfcprotocol.\+txt}} to ensure any client (even non-\/\+SFML ones) can implement the standard.
